...
%Here we consider a wrap toplogy and try to find the minimum distancebetween the AP and UT in wrap topology network
% rather than considering only one Cellular Netowork, which would be practical.
M=size(AP,1);
K=size(UT,1);
